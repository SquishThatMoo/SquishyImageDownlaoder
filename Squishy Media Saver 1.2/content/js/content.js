                ...
                if (tweetId !== undefined && token !== undefined && token != null) {
                    try {
                        let tweetContent = await fetch(`https://twitter.com/i/api/1.1/statuses/show/${tweetId}.json?tweet_mode=extended`, {
                            method: 'GET', 
                            headers: {'authorization' : 'Bearer AAAAAAAAAAAAAAAAAAAAANRILgAAAAAAnNwIzUejRCOuH5E6I8xnZz4puTs%3D1Zv7ttfk8LF81IUq16cHjhLTvJu4FA33AGWWjCpTnA', 'x-csrf-token':token}});
